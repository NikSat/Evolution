...
set output "AverageHap.png"
set ylabel "Average Licensing per Haplotype" font ",20"
set xlabel "Years" font ",20"
set xtics font ",15"
set ytics font ",15"
set yr [0:15]
#set label "Decoy Presenting Virus" font ",20" at 70000,9
plot "AverageHapLicense_L=1.txt" every 100 using 1:2 w l ls 1 title "Rec (%)=100" ,\
"AverageHapLicense_L=2.txt" every 100 using 1:2 w l ls 2 title "Rec (%)=96" ,\
"AverageHapLicense_L=3.txt" every 100 using 1:2 w l ls 3 title "Rec (%)=70" ,\
"AverageHapLicense_L=4.txt" every 100 using 1:2 w l ls 4 title "Rec (%)=40" ,\
"AverageHapLicense_L=5.txt" every 100 using 1:2 w l ls 5 title "Rec (%)=20" ,\
"AverageHapLicense_L=6.txt" every 100 using 1:2 w l ls 6 title "Rec (%)=9.8" ,\
"AverageHapLicense_L=7.txt" every 100 using 1:2 w l ls 7 title "Rec (%)=4.1" ,\
"AverageHapLicense_L=8.txt" every 100 using 1:2 w l ls 8 title "Rec (%)=2.4" ,\
"AverageHapLicense_L=9.txt" every 100 using 1:2 w l ls 9 title "Rec (%)=0.1" ,\
"AverageHapLicense_L=10.txt" every 100 using 1:2 w l ls 10 title "Rec (%)=0.06" 
