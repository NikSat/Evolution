...
$outfile="SI".$type."Average_L=".$number. ".txt";
# open the directory
...
while (my $subdir= readdir(DIR)) {
	...
	my $filename=$directory.'/Diversity_'.$type.'_L='.$number.'.txt';;
...
sub showHelp
{
	die("This script Calculates the mean of SI in each Directory
