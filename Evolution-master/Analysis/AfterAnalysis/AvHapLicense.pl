...
$outfile="AverageHapLicense_L=".$number. ".txt";
# open the directory
...
while (my $subdir= readdir(DIR)) {
	...
	my $filename=$directory.'/AVHaLicensed_L='.$number.'.txt';
...
sub showHelp
{
	die("This script Calculates the mean of KIR Haplotypes specificity in each Directory
