...
set output "AveragePresNonSelf.png"
set ylabel "Average Number of Presented Non Self Peptides" font ",20"
set xlabel "Years" font ",20"
set xtics font ",15"
set ytics font ",15"
set yr [0:25]
#set label "Decoy Presenting Virus" font ",20" at 70000,9
plot "PresentedPeptidesAverage_L=1.txt" every 100 using 1:3 w l ls 1 title "Rec (%)=100" ,\
"PresentedPeptidesAverage_L=2.txt" every 100 using 1:3 w l ls 2 title "Rec (%)=96" ,\
"PresentedPeptidesAverage_L=3.txt" every 100 using 1:3 w l ls 3 title "Rec (%)=70" ,\
"PresentedPeptidesAverage_L=4.txt" every 100 using 1:3 w l ls 4 title "Rec (%)=40" ,\
"PresentedPeptidesAverage_L=5.txt" every 100 using 1:3 w l ls 5 title "Rec (%)=20" ,\
"PresentedPeptidesAverage_L=6.txt" every 100 using 1:3 w l ls 6 title "Rec (%)=9.8" ,\
"PresentedPeptidesAverage_L=7.txt" every 100 using 1:3 w l ls 7 title "Rec (%)=4.1" ,\
"PresentedPeptidesAverage_L=8.txt" every 100 using 1:3 w l ls 8 title "Rec (%)=2.4" ,\
"PresentedPeptidesAverage_L=9.txt" every 100 using 1:3 w l ls 9 title "Rec (%)=0.1" ,\
"PresentedPeptidesAverage_L=10.txt" every 100 using 1:3 w l ls 10 title "Rec (%)=0.06" 
